<template>
<div class="siUp-content">
    <div class="siUp-context">
    <figure class="highlight html"><table><pre><tr><td class="code"><span class="line"> <span class="tag">
      &lt;<span class="name">p</span>&gt;  
       &lt;<span class="name">label</span> <span class="name">for=</span><span class="string">"name"</span>&gt; 이름&lt;<span class="name">/label</span>&gt;
       &lt;<span class="name">input</span> <span class="name">for=</span><span class="string">"name"</span> <span class="name">type=</span><span class="string">"text"</span>&gt; 
      &lt;<span class="name">/p</span>&gt;  
        &lt;<span class="name">p</span>&gt;  
       &lt;<span class="name">label</span> <span class="name">for=</span><span class="string">"name"</span>&gt; 이메일&lt;<span class="name">/label</span>&gt;
       &lt;<span class="name">input</span> <span class="name">for=</span><span class="string">"name"</span> <span class="name">type=</span><span class="string">"text"</span>&gt; 
      &lt;<span class="name">/p</span>&gt;  
        &lt;<span class="name">p</span>&gt;  
       &lt;<span class="name">label</span> <span class="name">for=</span><span class="string">"name"</span>&gt; 비밀번호&lt;<span class="name">/label</span>&gt;
       &lt;<span class="name">input</span> <span class="name">for=</span><span class="string">"name"</span> <span class="name">type=</span><span class="string">"text"</span>&gt; 
      &lt;<span class="name">/p</span>&gt;  
        &lt;<span class="name">p</span>&gt;  
       &lt;<span class="name">label</span> <span class="name">for=</span><span class="string">"name"</span>&gt; 비밀번호 확인&lt;<span class="name">/label</span>&gt;
       &lt;<span class="name">input</span> <span class="name">for=</span><span class="string">"name"</span> <span class="name">type=</span><span class="string">"text"</span>&gt; 
      &lt;<span class="name">/p</span>&gt;  
     &lt;<span class="name">p</span>&gt;  
       &lt;<span class="name">input</span> <span class="name">type=</span><span class="string">"submit"</span> <span class="name">value=</span><span class="string">"전송"</span>&gt; 
      &lt;<span class="name">/p</span>&gt;  
     </span></span></td></tr></pre></table>
    </figure>
</div>  
<div >
    <p>    
        <label class="index" for="name">이름</label>
        <input class="login-form" type="text" id="name">
    </p><br>
        <p>    
        <label class="index" for="name">이메일</label>
        <input class="login-form" type="text" id="name">
    </p><br>
        <p>    
        <label class="index" for="name">비밀번호</label>
        <input class="login-form" type="text" id="name">
    </p><br>
        <p>    
    ...
    <p>
        <input class="btn-login" type="submit" value="전송"/>
    </p></div>
</div>
</template>
<script>
